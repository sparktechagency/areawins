  ...
  return (
    <DashboardLayout>
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="w-full lg:w-64 space-y-2">
          <Card className="bg-card border-border overflow-hidden">
            ...
            <nav className="p-2 space-y-1">
              <Button
                variant="ghost"
                className="w-full justify-start gap-3 bg-primary/10 text-primary font-bold"
              >
              ...
              >
                ...
                <span className="ml-auto text-[10px] bg-green-500/20 text-green-500 px-1.5 py-0.5 rounded">
                  DONE
                </span>
              </Button>
              <Button
        ...
        {/* Main Content */}
        <div className="flex-1 space-y-6 bg-amber-400">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Your identity has been verified. You can withdraw unlimited
                    funds.
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between bg-white/5 p-3 rounded-lg border border-white/5">
                  <span className="font-medium text-sm">
                    Status: <span className="text-red-400">Disabled</span>
                  </span>
                  <Switch
            ...
            <Card className="bg-gradient-to-br from-[#1a2c24] to-primary/20 border-primary/20 text-white">
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-gray-400">
                  Share your code and earn 5% on every deposit.
                </p>
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => copyToClipboard("RAHIM505")}
                  >
