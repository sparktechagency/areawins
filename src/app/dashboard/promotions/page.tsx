      ...
      <div className="w-full mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {promotions.map((promo) => (
            <Card key={promo.id} className="overflow-hidden border-border bg-card">
              <div
                className="h-32 p-6 flex flex-col justify-end text-white relative "
              >
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button>Claim Offer <ArrowRight className="w-4 h-4 ml-2" /></Button>
                </div>
              </CardContent>
            </Card>
          ))}
