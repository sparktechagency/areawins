...
const MOCK_MESSAGES = {
    "1": [
        { id: "m1", content: "Hello, I have an issue with my withdrawal.", timestamp: "10:00 AM", isOwn: true, status: "read" },
        { id: "m2", content: "Hi! I can help you with that. What is your transaction ID?", timestamp: "10:05 AM", isOwn: false, senderName: "Support Team" },
        { id: "m3", content: "It's TXN123456.", timestamp: "10:06 AM", isOwn: true, status: "read" },
        { id: "m4", content: "Your withdrawal has been processed.", timestamp: "10:30 AM", isOwn: false, senderName: "Support Team" }
    ],
    "2": [
        { id: "m5", content: "Yo, are you betting on the game tonight?", timestamp: "Yesterday", isOwn: false, senderName: "John Doe" },
        { id: "m6", content: "Yeah, Man City looks strong.", timestamp: "Yesterday", isOwn: true, status: "read" }
    ]
};
