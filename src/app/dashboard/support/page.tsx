    ...
    <DashboardLayout>
      <div className="w-full mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className="flex flex-col items-center text-center border border-border shadow-none p-6">
          ...
          <Card className="flex flex-col items-center text-center p-6 border border-border shadow-none">
            <div className="p-4 bg-primary/10 rounded-full mb-4">
