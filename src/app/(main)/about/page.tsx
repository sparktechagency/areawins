    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-12 border-y border-border bg-card/50">
        <div className="container mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
                ...
                <div className="text-xs uppercase tracking-wider text-primary font-bold">Active Users</div>
            </div>
            <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-foreground mb-2">1,000+</div>
                <div className="text-xs uppercase tracking-wider text-primary font-bold">Daily Matches</div>
            </div>
            <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-foreground mb-2">24/7</div>
                <div className="text-xs uppercase tracking-wider text-primary font-bold">Bangla Support</div>
            </div>
            <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-foreground mb-2">99.9%</div>
                <div className="text-xs uppercase tracking-wider text-primary font-bold">Uptime</div>
            </div>
        </div>
      </section>
      ...
      <section className="py-20 container mx-auto px-4">
              ...
              <div className="order-2 md:order-1 relative rounded-2xl overflow-hidden aspect-video bg-card border border-border">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-tr from-primary/20 to-transparent flex items-end p-8">
                      <div>
                          ...
                          <p className="text-sm text-gray-200">Experience the thrill from anywhere, anytime.</p>
                      </div>
                  </div>
              </div>
              <div className="order-1 md:order-2">
                  <div className="text-primary text-xs font-bold uppercase tracking-wider mb-2">Our Mission</div>
                  <h2 className="text-3xl font-bold text-foreground mb-4">Empowering the Modern Bettor</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
               <div>
                  <div className="text-primary text-xs font-bold uppercase tracking-wider mb-2">Our Vision</div>
                  <h2 className="text-3xl font-bold text-foreground mb-4">The Future of Interactive Sports</h2>
                  <p className="text-muted-foreground leading-relaxed mb-6">
      ...
      <section className="py-20 bg-card">
          <div className="container mx-auto px-4">
              <h2 className="text-3xl md:text-4xl font-bold text-center text-foreground mb-4">Why Choose EasyBet</h2>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                  ...
                  <div className="p-8 rounded-2xl bg-background/50 border border-border hover:border-primary/50 transition-colors group">
                      ...
                      <h3 className="text-xl font-bold text-foreground mb-3">Integrity & Fair Play</h3>
                      <p className="text-muted-foreground text-sm leading-relaxed">Guaranteed transparent odds and instant payouts you can trust. We operate with the highest standards of security.</p>
                  </div>
                  ...
                  <div className="p-8 rounded-2xl bg-background/50 border border-border hover:border-primary/50 transition-colors group">
                      ...
                      <h3 className="text-xl font-bold text-foreground mb-3">Cutting-edge Innovation</h3>
                      <p className="text-muted-foreground text-sm leading-relaxed">Live betting technology that keeps up with every match moment. Experience zero lag during crucial plays.</p>
                  </div>
                  ...
                  <div className="p-8 rounded-2xl bg-background/50 border border-border hover:border-primary/50 transition-colors group">
                      ...
                      <p className="text-muted-foreground text-sm leading-relaxed">Tailored specifically for the local Bangladeshi market with 24/7 Bangla support and local payment methods.</p>
                  </div>
                  ...
                  <div className="p-8 rounded-2xl bg-background/50 border border-border hover:border-primary/50 transition-colors group">
                      ...
                      <h3 className="text-xl font-bold text-foreground mb-3">Instant Withdrawals</h3>
                      <p className="text-muted-foreground text-sm leading-relaxed">Get your winnings fast. We support bKash, Nagad, and Rocket for seamless transactions.</p>
                  </div>
                  ...
                  <div className="p-8 rounded-2xl bg-background/50 border border-border hover:border-primary/50 transition-colors group">
                      ...
                      <h3 className="text-xl font-bold text-foreground mb-3">Cricket Specialists</h3>
                      <p className="text-muted-foreground text-sm leading-relaxed">The best odds on BPL, IPL, and International Cricket. We know what the fans want.</p>
                  </div>
                  ...
                  <div className="p-8 rounded-2xl bg-background/50 border border-border hover:border-primary/50 transition-colors group">
                      ...
                      <p className="text-muted-foreground text-sm leading-relaxed">Your data is protected by industry-standard SSL encryption. We never share your info.</p>
                  </div>
              </div>
          </div>
      </section>
      ...
      <section className="py-24 container mx-auto px-4">
          <div className="bg-card rounded-3xl p-12 text-center border border-border relative overflow-hidden">
              ...
              <div className="relative z-10">
                  <h2 className="text-4xl font-bold text-foreground mb-6">Ready to Win?</h2>
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                      <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold min-w-[200px] h-14 text-lg">
                          Join Now
                      </Button>
                      <Button variant="outline" size="lg" className="border-border text-foreground hover:bg-muted bg-transparent min-w-[200px] h-14 text-lg">
                          Contact Support
                      </Button>
                  </div>
              </div>
