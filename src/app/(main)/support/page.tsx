            ...
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                    <Card className="text-center hover:border-primary transition-colors">
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground mb-4">Average response time: 2 mins</p>
                    ...
                    <Card className="text-center hover:border-primary transition-colors">
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground mb-4">support@easybet.com</p>
                    ...
                    <Card className="text-center hover:border-primary transition-colors">
                        ...
                        <CardContent>
                            <p className="text-sm text-muted-foreground mb-4">+880 1XXX XXXXXX</p>
                ...
                <div className="text-center">
                    <p className="text-muted-foreground mb-4">Looking for general information?</p>
