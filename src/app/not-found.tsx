      ...
      <div className="w-full max-w-xl text-center">
        <div className="mb-6 flex justify-center text-primary">
          <div className="relative">
            <span className="text-8xl font-black italic tracking-tighter opacity-10 sm:text-9xl">
              404
            </span>
        ...
        <p className="mx-auto mt-4 max-w-md text-base leading-relaxed text-muted-foreground">
          The tactical route you took led to an empty field. This match doesn&apos;t exist 
          or has been moved to another stadium.
        </p>
