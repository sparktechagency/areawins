...
export default function DashboardSidebar() {
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full bg-card dark:bg-background text-card-foreground border-r border-border">
      {/* Logo Area */}
    ...
    <>
      ...
      <div className="lg:hidden p-4 sticky top-0 z-50 bg-background border-b border-border flex items-center justify-between">
        ...
        <Sheet open={isMobileOpen} onOpenChange={setIsMobileOpen}>
          ...
          <SheetContent side="left" className="p-0 border-r border-border w-64 bg-card dark:bg-background">
            <SidebarContent />
          </SheetContent>
        </Sheet>
      </div>
