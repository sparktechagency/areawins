  ...
  const faqs = [
    {
      ...
      answer:
        "Go to Dashboard > Wallet > Deposit. Select your preferred payment method (credit card, bank transfer, or digital wallet), enter the amount, and follow the on-screen instructions to complete the transaction.",
    },
    {
      id: "withdrawal",
      question: "What is the minimum withdrawal?",
      answer:
        "The minimum withdrawal amount is $10 USD. Withdrawals are typically processed within 24 hours.",
    },
    {
      id: "restricted",
      question: "Why is my account restricted?",
      answer:
        "Accounts may be restricted due to verification pending, suspicious activity, or violation of our terms. Please contact support for assistance.",
    },
  ];
    ...
    <div className="min-h-screen bg-background text-foreground pb-20">
      ...
      <div className="relative py-12 md:py-20 px-4 sm:px-6 lg:px-12 xl:px-16 bg-card overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 text-center relative z-10">
          ...
          <p className="max-w-xl mx-auto text-muted-foreground text-sm sm:text-base md:text-lg">
            Have a question about your bet, deposit, or account verification?
      ...
      <div className="py-12 px-4 sm:px-6 lg:px-12 xl:px-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-8">
          ...
          <div className="bg-card border border-border p-4 sm:p-6 md:p-8 rounded-2xl">
            ...
            <form className="space-y-4 md:space-y-6">
              <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                <div className="space-y-1.5 md:space-y-2">
                  <Label htmlFor="fullname" className="text-foreground text-sm md:text-base">
                    Full Name
                  </Label>
                  <Input
                    id="fullname"
                    placeholder="Enter your full name"
                    className="bg-background border-border text-foreground placeholder:text-muted-foreground focus:border-primary/50 h-10 md:h-12 text-sm"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-background border-border text-foreground placeholder:text-muted-foreground focus:border-primary/50 h-12"
                  />
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    id="subject"
                    className="flex h-12 w-full items-center justify-between rounded-md border border-border bg-background px-3 py-2 text-sm text-foreground ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary/50 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1"
                  >
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="bg-background border-border text-foreground placeholder:text-muted-foreground focus:border-primary/50 min-h-[150px] resize-none"
                />
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card border border-border rounded-2xl overflow-hidden">
              ...
              <div className="p-4 bg-background">
                <Button
                  variant="outline"
                  className="w-full border-border text-primary hover:text-primary hover:bg-muted bg-transparent"
                >
                  View Help Center
                </Button>
              </div>
            ...
            <div className="bg-background border border-border rounded-lg p-4 flex items-center gap-3">
              ...
              <p className="text-xs text-muted-foreground">
                Your data is protected by 256-bit SSL encryption. We never share
                your details.
              </p>
            </div>
          </div>
