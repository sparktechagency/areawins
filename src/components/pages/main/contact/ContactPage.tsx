  ...
  const faqs = [
    {
      ...
      answer:
        "Go to Dashboard > Wallet > Deposit. Select bKash, enter the amount, and follow the on-screen instructions to complete the transfer via your bKash app.",
    },
    {
      id: "withdrawal",
      question: "What is the minimum withdrawal?",
      answer:
        "The minimum withdrawal amount is 1,000 BDT. Withdrawals are typically processed within 24 hours.",
    },
    {
      id: "restricted",
