      ...
      <div className="mb-8">
         ...
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Link href={ROUTES.PROMOTIONS || "/promotions"} className="block group">
               <Card className="h-40 relative overflow-hidden border-0 bg-gradient-to-br from-gray-500 to-gray-800 group-hover:scale-[1.02] transition-transform duration-300">
            ...
            <Link href={ROUTES.MY_BETS || "/my-bets"} className="block group">
               <Card className="h-40 flex flex-col items-center justify-center bg-card  border-border shadow-none transition-colors cursor-pointer text-center p-4">
