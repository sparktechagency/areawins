    ...
    <AuthLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Please Enter Your Email Address To Reset Password.</p>
        </div>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      type="email"
                      placeholder="type email or user here"
                      className="h-12"
                      {...field}
                    />
                  </FormControl>
        ...
        <div className="space-y-3">
          <Button type="button" variant="outline" className="w-full h-12 text-foreground border-border">
